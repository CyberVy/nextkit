...
export const playlists_icon = (
    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="7.5" cy="12.25" r="0.9" fill="currentColor" />
        <path d="M9.5 12.25H12.5" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" />
        <circle cx="7.5" cy="15.75" r="0.9" fill="currentColor" />
        <path d="M9.5 15.75H11.5" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" />
    </svg>
)
...
export const playlist_icon = (
    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M10.5 10H14.5" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" />
        <circle cx="8.25" cy="14" r="0.9" fill="currentColor" />
        <path d="M10.5 14H12.75" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" />
    </svg>
)
...
export const copy_icon = (
    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
        ...
        <path
            d="M15 7V6C15 4.89543 14.1046 4 13 4H7C5.89543 4 5 4.89543 5 6V14C5 15.1046 5.89543 16 7 16H9"
            stroke="currentColor"
            strokeWidth="1.25"
            strokeLinecap="round"
            strokeLinejoin="round"
...
export const login_icon = (
    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
        ...
        <path d="M9.25 16C9.95 14.45 10.9 13.75 12 13.75C13.1 13.75 14.05 14.45 14.75 16" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" />
    </svg>
)
...
export const list_loop_icon = (
    <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
        ...
        <path d="M7 21l-3-3 3-3" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M21 13v2C21 16.6569 19.6569 18 18 18H4" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
)
...
export const loop_icon = (
    <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
        ...
        <path d="M7 21l-3-3 3-3" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M21 13v2C21 16.6569 19.6569 18 18 18H4" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M11 10.5L12 10V14" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
)
...
export const shuffle_icon = (
    <svg width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
        ...
        <path d="M21 16v5h-5" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M15 15l6 6" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M4 4l5 5" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
)
...
export const pip_icon = (
    <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
        ...
        <path d="M14.5 12.9L16.45 13.75L14.5 14.6V12.9Z" fill="currentColor" />
    </svg>
)
...
export const captions_icon = (
    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
        ...
        <path d="M7.5 14H12.5" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" />
        <path d="M14.5 14H16.5" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" />
    </svg>
)
...
export const alarm_icon = (
    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
        ...
        <path d="M8 6L6.2 4.2" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" />
        <path d="M16 6L17.8 4.2" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" />
        <path d="M8 19L6.2 20.8" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" />
        <path d="M16 19L17.8 20.8" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" />
    </svg>
)
...
export const eraser_icon = (
    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
        ...
        <path d="M10.5 8L16.5 14" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
)
...
export const fullscreen_icon = (
    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
        ...
        <path d="M14.5 9.5H16.5V11.5" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M9.5 14.5H7.5V12.5" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M14.5 14.5H16.5V12.5" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
)
